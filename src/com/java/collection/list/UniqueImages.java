...
class UniqueImages {
    ...
    public static void main(String[] args) {
		UniqueImages.Image images[] = { new UniqueImages().new Image("flag.jpg", 40, 60),
				new UniqueImages().new Image("flag.gif", 40, 60), new UniqueImages().new Image("smile.gif", 100, 200),
				new UniqueImages().new Image("smile.gif", 50, 400), new UniqueImages().new Image("other.jpg", 40, 60),
				new UniqueImages().new Image("lenna.jpg", 512, 512),
				new UniqueImages().new Image("Lenna.jpg", 512, 512) };
