...
public class Utility {
	...
	public static void main(String[] args) {
		/*
		 * Scanner in=new Scanner(System.in); int size=intialInput(in); int
		 * ar[]=new int[size]; inputArray(in, ar); sum(ar); int
		 * res=getMissingNo(ar, 5); System.out.println("Utility.main()"+res);
		 */
	...
	public static void backprint(int ar[]) {
		for (int i = ar.length - 1; i >= 0; i--) {
			System.out.println("from back " + ar[i]);
		}
	}
